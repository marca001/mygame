label day2decision1_lookfornick:
    ...
    "You think about this morning and the way Nick acted…" 
    "It wouldn’t hurt just to see what he was up to, right?"
    "Maybe you could ask him more about it."
    "Regardless, it’s better than just sitting here alone."
    "You turn around in your seat and see that Nick isn’t there."
    ...
    "You make your way out of the classroom, where the hallway is bustling." 
    "It’s more lively than usual because of the festival."
    ...
    "...Wait. Waffles?"
    "You sniff again." 
    "Yeah, that’s definitely waffles. Or at least something delicious smelling."
    "???" "...Liz?"
    ...
    n "Y-yeah. So what?"
    l "Ummm… Cool!"
    "You walk over and sit down next to him against the wall." 
    "He’s honestly just squatting down and making waffles."
    ...
    show nick seriousb with dissolve
    "You can’t help your flirtatious tone, especially with the way he squirms. It’s amusing to see him try not to react."
    ...
    "Under the light blue sky, you and Nick eat waffles together and chat lightly."
    ...
    show nick frownb with dissolve
