label day1afternoon:
    ...
    show myca surprised
    m "Ehh, not necessarily. A lot of students switch around what class they help with, I did that yesterday."
    m "Don’t think they really care."
    l "That’s true…"
    ...
    "Later, you hold your extremely pudgey and round cat up in the air over you."
    "Not only does your kitty look cute hovering over you, but the cat’s obesity serves as a nice muscle-building exercise for your arms."
    l "Sigh… Oh Momo! Does he love me??? DOES HE???"
    "Momo" "Meow."
    l "Oh Momo, that makes no sense. You should have another kitty cat treat."
    "You put Momo down and he waddles over to his food bowl as you dump some treats in it."
