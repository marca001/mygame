...
init -1 python hide:
    ...
    theme.roundrect(
        ...
        mm_root = "bg/titlescreenfull.png",
...
python early:
    config.save_directory = "mygame-1406933566"
...
init python:
    ...
    build.directory_name = "DokiDokiChance-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "DokiDokiChance"
