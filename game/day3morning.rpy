label day3morning:
    ...
    show text "~Day 3~" with pixellate
    
    show text "~Day 3~" with Pause(2)
    ...
    m "N-NO! That art was definitely just weird and not sexy or anything…!" with vpunch
    
    hide myca with dissolve
    
    "You make your way to the next classroom and it just gets fucking weirder."
