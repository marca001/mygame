label day3decision1_kaito:
    ...
    "Kaito" "Umm… Hello."
    "He’s looking nervous, but when he sees you in the crowd, his eyes light up."
    ...
    l "({i}Kaito-senpai… I’ll smile for you… ALWAYS!{/i})"
    ...
    if k_points <= n_points:
        ...
        k "We have grown apart over the years, but I’ll never stop loving you…"
        ...
        l "({i}I… I feel like I’m missing something. I thought maybe… something would happen.{/i})"
        l "({i}I guess I really am just a friend to him…{/i})"
        l "({i}Maybe I should have spent more time with him…{/i})"
        l "({i}If I’m just his friend… He might think it’s weird if I ask him to dance…{/i})"
    ...
    "Your eyes meet again with Kaito’s, and you old his hand tigether."
