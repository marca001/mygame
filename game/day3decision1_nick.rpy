label day3decision1_nick:
    ...
    n "Come see our Haunted House… It’s… it’s spooky…"
    l "...Really Nick?"
    "Nick looks up, surprised to see you."
    ...
    n "N-no…"
    n "I mean, I worked on almost all this…"
    l "Oh that’s true! You really are talented, Nick. This whole thing looks amazing!"
    ...
    if n_points <= k_points:
        ...
        n "...T-thanks for coming though."
        l "Oh okay. And no problem!"
        "..."
    ...
    n "Look, you wanted a formal response, right?"
    n "T-to your confession…"
    n "And the answer is…"
    "He takes a deep breath and looks directly at you with determination in his eyes."
    n "Yes…"
    n "I like you too!"
