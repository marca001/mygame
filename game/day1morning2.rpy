label day1morning2:
    ...
    "You two continue your conversation until you reach the school."
    "You split up as you head to the second year classroom, and Kaito heads up to the third year classrooms."
    ...
    "The conversation continued on like in the early hours of the morning."
    "To others, your borderline flirting and his hot-and-cold behavior might seem weird, but this was a normal conversation between you two."
    ...
    "Sure enough, you had begun to develop feelings for him, and confessed…"
    "Yet…"
    ...
    "???" "HEY LIZ!!!" with vpunch
    "Oh god, it can't be."
    "That slimey, screechy voice could only belong to one person."    
    "It was…"
    "...John."
    ...
    #show nick seriousb at right with dissolve
    ...
    "After a ton of awkward conversation, the first bell rings."
    "You and Nick say goodbye to John as he rushes to his seat."
    ...
    "Before you know it, you had teleport-slept through to lunch."
    "You’re jolted awake as someone pokes you in the shoulder."

    show myca normal
    with dissolve  

    m "PSSSST." with vpunch
    ...
    l "Oh my gosh, Myca!!"
    l "JOHN showed up and hung around our class like alllll morning. It was the WORST."
    ...
    m "They want the V."
    m "Your V."
    m "Like, your {i}vagina.{/i}" 
    l "B-but! But! Nick never responded to all my love letters… " 
    
    show myca normal
    
    l "He hates me, Myca!!" with vpunch
    m "Honestly, I think he’s just super shy and anti-social."
    m "You’re the only one he really opens up to."
    ...
    "You’re a mix of happy and flustered when you think about the guys you have a crush on liking you back..."
    "...but at the same time can’t help but wonder why nothing has come to fruition between the two."
    ...
    "Students are making their way back to their seats as lunch period nears its end."
    "Just before Myca returns to her seat, she asks you one more thing."
