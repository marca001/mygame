label day2decision1_gotoanimeclubanyway:
    ...
    "You don’t like sitting alone like this, so your impulse is just to get up and follow Myca." 
    "Maybe you can talk to her when she is done and just eat in the clubroom until then?"
    "You make your way to the clubroom hall, blending in along with all the bustling traffic in the hallway." 
    "It really was lively, with the festival tomorrow…"
    "You’re not sure what the Anime Club is planning. Actually, the closer you get the clubroom, the more you feel your stomach drop."
    ...
    "Immediately magical girl music is blasting in the background." with vpunch
    ...
    "Some of them are debating about power levels, others are comparing drawings of some lewd boy on boy action."
    
    hide myca with dissolve
    
    "A girl and her friend are dancing in corner to the music with idol-like grace."
    "A goth looking girl sighs angrily." 
    "An overweight guy pushes up his glasses and is yelling his waifus name as he reads his manga." 
    "Another girl openly picks at the pimples on her legs"
    ...
    "The students either watch or are move to talk to their friends." 
    
    hide myca with dissolve
    
    "Myca is busy talking to another classmate, but a few familiar people approach."  
    "Rhiannan" "HEY LIZ" with vpunch
    "She jumps up from behind you and you resist the urge to self-defensively punch her." 
    "Rhiannan is wearing a Konoha Naruto symbol on its head and has a fake kunai strapped to her waist." 
    "You wonder why it hasn’t been confiscated yet."
    ...
    "You motion at the plastic kunai and Rhiannan jumps into a defensive stance, wielding it." 
    "You instinctively move away in your seat."
    ...
    "Rhiannan" "I’m in my SASUKE mode, you know?!" with vpunch
    "Rhiannan" "From Naruto."
    l "Ah… yes."
    "Rhiannan" "Great! I’m glad you recognize me!"
    "Rhiannan" "OH, I just thought of this great move I could do, I gotta go tell Kristen…"
    "Rhiannan" "JA NE, LIZ-SAN."
    "She rushes off with her arms limply flailing behind her to wherever. You just sigh to yourself, happy she’s gone."
    ...
    l "I DID, but don't tell her I said that." with vpunch
    ...
    "And there he is… John-kun." 
    "He is looking blobby as ever and jiggles with excitement as you lock eyes from across the room."
    ...
    j "Err… it’s my Chewbacca impression!"
    j "You said you {i}love{/i} my Chewbacca impression!"
    l "I… I did?"
