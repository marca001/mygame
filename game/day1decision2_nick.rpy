label day1decision2_nick:
    ...
    "Occasionally you can hear Myca in the background going, \"Spoooopy, so spoooopy!\""
    l "But, yeah!"
    ...
    "Nick moves to your side of the room as he shows you what to do. "    
    "...Well, you kind of already knew, but you still thank him every step of the way. "
    "You spend your time working together on the cardboard pieces, gradually transforming them into somewhat scary pieces for a Haunted House."
    "You finish another prop together, looking at it proudly. It’s a tree that looks really mad and has sharp teeth. "
    "Okay, well, maybe it looks more cute than scary, but whatever! You’re sure they’ll use some lighting trick to make it look truly horrifying."
    ...
    "You both reach down at the same time again, but freeze up again, babble at each other a bit more, until finally you swiftly pick the bottle up off the ground."
    l "l’ve got it! Hahaha.. ha."
    n "Yeah…"
    "There’s a brief awkward silence between you. "
    "You look desperately around the classroom to see if any other classmates saw the little spectacle, not sure what to do with yourself."
    ...
    n "If you really want to, I guess... Let’s work on just one more."
    l "Yay!"
    
    hide nick with dissolve
    
    "You cheer loudly with that bottle in your hand. Nick scolds you not to drop it again and you quickly make yourself serious again. "
    "After using the glue and a few markers, you can’t help but glow at your progress."
    "Absent mindedly, you reach for the box cutter for the next step. "
    "Without warning, you feel a sharp pain on the palm of your hand. "
    l "Ouch!" with vpunch
    
    show nick worry with dissolve
    
    n "What’s wrong?"
    "You look down and see a cut on your hand, blood smeared around it. "
    
    show nick shock
    
    "It’s only a mild sting, but Nick already has grabbed your hand and is looking at the small cut in silent horror."
    n "Liz…!"
    l "Er.. sorry! Don’t worry, it’s only a c--"
    
    show nick worry with dissolve
    
    n "Don’t move your hand!" with vpunch
    "Nick already has rushed over with a first aid kit."
    l "Wow, I didn't know we had a first aid kid here."
    ...
    n "Look, I never said no, okay? I’m just.. "
    
    show nick worryt with dissolve
    
    n "I... I don’t know what I want… "
    n "...I should go."
    
    hide nick with dissolve
    
    "He quickly grabs his bag and hurriedly leaves the classroom."
    "You watch him go quietly, not knowing how to feel."
    l "Nick-kun..."
    "The truth was that you had confessed your feelings to him a couple of weeks ago... but he never said anything back."
    "So, of course you couldn't help but take it as rejection. "
    "On the other hand, his behavior today and what he had just said..."
    "He seemed keen on making it clear that he hasn’t turned you down yet."
    "Perhaps he really does like you back...?"
    "You can feel the butterflies in your stomach fluttering all over again, but at the same time your brain is telling you to be rational."
