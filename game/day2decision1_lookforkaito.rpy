label day2decision1_lookforkaito:
    ...
    "You think about how Kaito asked for your help for his club’s event… Even if you can’t help later on today, you two could at least have lunch together."
    "You head to Kaito’s classroom, blending in along with all the bustling traffic in the hallway. It really was lively, with the festival tomorrow…"
    "When you get there, however, Kaito is nowhere to be seen. Some of the students there look up at you."
    ...
    "You close your eyes and listen. Could it be…?"
    "..."
    "That’s definitely Kaito’s voice! You’ve opened the roof door silently at this point and walk outside."
    ...
    "You close your eyes and listen again, taking it all in. You’ve always loved his singing voice, despite how rarely he does it."
    ...
    k "You know I don’t like singing in front of people… It’s embarrassing."
    ...
    l "Yeah!"
    "You dig out your OBENTO, which is of course a culinary master piece. It is a perfectly balanced meal, with the perfect proportions of veggies, rice, and meat that smiles back at you. Not only is it nutritious, but it is also incredibly moe looking."
    ...
    "He looks up at you in surprise, not saying anything. Impatiently, you pop it in his mouth."
    k "?!"
    ...
    "You suppress a disappointed gasp. The spoon was from the ice cream container he has with him..."
    l "O-oh… Yeah."
